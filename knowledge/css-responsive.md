...
- [What is Responsive Design & Why It Matters 🌐](#what-is-responsive-design--why-it-matters-)
  - [The Problem It Solves](#the-problem-it-solves)
  - [How It Actually Works](#how-it-actually-works)
  - [One Stylesheet to Rule Them All](#one-stylesheet-to-rule-them-all)
  - [Key Takeaways 📋](#key-takeaways-)
- [The Viewport 🖼️](#the-viewport-️)
  - [What the Viewport Is](#what-the-viewport-is)
  - [Viewport on Desktop vs Mobile](#viewport-on-desktop-vs-mobile)
  - [The Viewport Meta Tag](#the-viewport-meta-tag)
  - [Checking the Viewport in DevTools](#checking-the-viewport-in-devtools)
  - [Key Takeaways 📋](#key-takeaways--1)
- [Mobile First 📱](#mobile-first-)
  - [What Mobile First Means](#what-mobile-first-means)
  - [Mobile First vs Desktop First](#mobile-first-vs-desktop-first)
  - [Why Mobile First Produces Simpler CSS](#why-mobile-first-produces-simpler-css)
  - [Mobile First in Design vs Mobile First in Code](#mobile-first-in-design-vs-mobile-first-in-code)
  - [Key Takeaways 📋](#key-takeaways--2)
- [Responsive Units 📏](#responsive-units-)
  - [Why Units Matter for Responsive Design](#why-units-matter-for-responsive-design)
  - [Percentage (`%`)](#percentage-)
  - [Viewport Units (`vw`, `vh`, `vmin`, `vmax`)](#viewport-units-vw-vh-vmin-vmax)
  - [`rem` — Root EM](#rem--root-em)
  - [`em` — Relative EM](#em--relative-em)
  - [`calc()`](#calc)
  - [Choosing the Right Unit](#choosing-the-right-unit)
  - [Key Takeaways 📋](#key-takeaways--3)
- [Media Queries 🔍](#media-queries-)
  - [What a Media Query Is](#what-a-media-query-is)
  - [The Syntax](#the-syntax)
  - [How the Browser Actually Recognises Conditions](#how-the-browser-actually-recognises-conditions)
  - [Media Types](#media-types)
  - [`min-width` and `max-width`](#min-width-and-max-width)
  - [Combining Conditions](#combining-conditions)
  - [Writing Media Queries Inside Rules](#writing-media-queries-inside-rules)
  - [Key Takeaways 📋](#key-takeaways--4)
- [Breakpoints 📐](#breakpoints-)
  - [What a Breakpoint Actually Is](#what-a-breakpoint-actually-is)
  - [Common Breakpoints](#common-breakpoints)
  - [How Breakpoints Stack in Mobile First CSS](#how-breakpoints-stack-in-mobile-first-css)
  - [Content-Driven vs Device-Driven Breakpoints](#content-driven-vs-device-driven-breakpoints)
  - [Framework Breakpoints](#framework-breakpoints)
  - [A Pro Tip — CSS Custom Properties and Breakpoints](#a-pro-tip--css-custom-properties-and-breakpoints)
  - [Key Takeaways 📋](#key-takeaways--5)
- [Common Media Features 🎛️](#common-media-features-️)
  - [Screen Size](#screen-size)
  - [Orientation](#orientation)
  - [Pointer](#pointer)
  - [Device Pixel Ratio (Pixel Density)](#device-pixel-ratio-pixel-density)
  - [Color Scheme](#color-scheme)
  - [Reduced Motion](#reduced-motion)
  - [High Contrast](#high-contrast)
  - [Key Takeaways 📋](#key-takeaways--6)
- [Responsive Images — The `<picture>` Element 🖼️](#responsive-images--the-picture-element-️)
  - [The Problem with a Single `<img>`](#the-problem-with-a-single-img)
  - [How `<picture>` Works](#how-picture-works)
  - [Why Source Order Matters](#why-source-order-matters)
  - [Comparing to Media Queries](#comparing-to-media-queries)
  - [Art Direction — Different Images, Not Just Different Sizes](#art-direction--different-images-not-just-different-sizes)
  - [The `<img>` Fallback Is Required](#the-img-fallback-is-required)
  - [Key Takeaways 📋](#key-takeaways--7)
- [Quick Reference 📚](#quick-reference-)
  - [The Viewport Meta Tag](#the-viewport-meta-tag-1)
  - [Media Query Syntax](#media-query-syntax)
  - [Common Breakpoints](#common-breakpoints-1)
