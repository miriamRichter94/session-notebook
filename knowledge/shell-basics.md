...
- [Essential Commands with Context](#essential-commands-with-context)
  ...
  - [File and Directory Operations](#file-and-directory-operations)
    ...
    - [`mv` - Move or Rename](#mv---move-or-rename)
    - [`rm` - Remove (Delete) Files](#rm---remove-delete-files)
  - [Viewing and Editing Content](#viewing-and-editing-content)
    ...
    - [`open` - Open in Default Application](#open---open-in-default-application)
    - [`code` - Open in VS Code](#code---open-in-vs-code)
  - [Utility Commands](#utility-commands)
    - [`clear` - Clear the Screen](#clear---clear-the-screen)
    - [`curl` - Fetch Content from a URL](#curl---fetch-content-from-a-url)
- [Common Mistakes & Troubleshooting](#common-mistakes--troubleshooting)
  ...
  - [Lost and Don't Know Where You Are](#lost-and-dont-know-where-you-are)
  - [Typed Something Wrong and Can't Stop It](#typed-something-wrong-and-cant-stop-it)
  - [Terminal is Cluttered and Messy](#terminal-is-cluttered-and-messy)
  - [Can't Remember the Exact Command You Used Before](#cant-remember-the-exact-command-you-used-before)
  - [Typed a Long Folder Name Wrong](#typed-a-long-folder-name-wrong)
- [Helpful Shortcuts & Quick Reference](#helpful-shortcuts--quick-reference)
  ...
  - [Special Symbols Reference](#special-symbols-reference)
